                        ...
                        <div class="card-body pt-5">
                            ...
                            <form id="kt_ecommerce_settings_general_form" class="form">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <select class="form-select form-select-solid" name="country"
                                                    ...
                                                    <option value="MS" data-kt-select2-country="flags/montserrat.svg">
                                                        Montserrat</option>
                                                    <option value="MA" @if ( $user->country =="MA") selected @endif data-kt-select2-country="flags/morocco.svg">Morocco
                                                    </option>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <textarea class="form-control form-control-solid" name="notes">{{ $user->notes }}</textarea>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Separator-->
